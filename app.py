...
# --- UI ---
st.set_page_config(page_title="Renovation Feasibility Calculator", page_icon="🏗️")
st.title("🏗️ Renovation Feasibility Engine")
...
st.warning("⚠️ Automated estimate only. For a verified quote review, contact [Your Name] at [Your Email].")
